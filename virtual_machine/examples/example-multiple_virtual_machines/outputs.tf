  ...
  value = [
    {
      ...
      ipv4_address = module.test1.ipv4_address
    },
    {
      id           = module.test2.id
      name         = module.test2.name
      ipv4_address = module.test2.ipv4_address
    },
    {
      id           = module.test3.id
      name         = module.test3.name
      ipv4_address = module.test3.ipv4_address
    },
    {
      id           = module.test4.id
      name         = module.test4.name
      ipv4_address = module.test4.ipv4_address
    }
  ]
}
